...
//    NSLog(@"---根视图%f",[fK bounds].size.height);
//    NSLog(@"---根视图%f",[fK bounds].size.width);
//    NSLog(@"---根视图%f",[fK bounds].origin.x);
//    NSLog(@"---根视图%f",[fK bounds].origin.y);
    [_splashAd loadAdAndShowInWindow:fK withBottomView:_bottomView];
//    [_splashAd loadAdAndShowInWindow:fK];
}
